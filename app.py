...
def analyze_urls_from_text(text):
    ...
    if not urls:
        return [{
            ...
            "combined_result": "Detected: N/A - Accuracy: 0.00%"
        }]
    ...
    for url in set(urls):
        ...
        detection_status = "Phishing URL" if is_phishing or safe_browse_score > 0 else "Safe URL"
        
        combined_result = f"Detected: {detection_status} - Accuracy: {accuracy_score:.2f}%"
